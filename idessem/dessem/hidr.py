...
from typing import Any, Dict, Type, TypeVar, List, Optional, IO, Union
...
class Hidr(RegisterFile):
    ...
    @classmethod
    def __detecta_versao(cls, content: Union[str, bytes]) -> Optional[str]:
        """
    ...
    def converte_tamanho_registro(self, precisao: str) -> None:
        ...
        :param precisao: A precisão dos coeficientes dos polinômios
            ('f32' ou 'f64')
        """
